...
PREPROCESSED="assets/examples/source/chac-bolay.fsp"
...
python3 scripts/copy_landmarks.py \
  --source "assets/examples/source/chac-bolay_before.fsp" \
  --target "assets/examples/source/chac-bolay.fsp" \
  --output "assets/examples/source/chac-bolay.fsp"
